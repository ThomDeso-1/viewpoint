...
describe('practice queue', () => {
  let ctx: TestContext;
  let queue: typeof import('../server/services/practice-queue.js');
  let examRequests: typeof import('../server/services/exam-requests.js');
  ...
  beforeEach(async () => {
    ...
    queue = await import('../server/services/practice-queue.js');
    examRequests = await import('../server/services/exam-requests.js');
  ...
  describe('approval', () => {
    ...
    it('rejecting cancels the drafted reminder so it never sends', async () => {
      const { row } = await seedDrafted();
      const reminders = await import('../server/services/reminders.js');
