...
describe('mock HCV client', () => {
  let ctx: TestContext;
  let ohip: typeof import('../server/services/ohip/index.js');

  beforeEach(async () => {
    ctx = await setupTestApp();
    ohip = await import('../server/services/ohip/index.js');
  });
...
describe('SOAP envelope construction', () => {
  let ctx: TestContext;
  let soap: typeof import('../server/services/ohip/hcv-soap.js');
  let config: import('../server/services/ohip/hcv-soap.js').HcvSoapConfig;

  beforeEach(async () => {
    ctx = await setupTestApp();
    soap = await import('../server/services/ohip/hcv-soap.js');
...
describe('eligibility service', () => {
  let ctx: TestContext;
  let eligibility: typeof import('../server/services/eligibility.js');
  let patients: typeof import('../server/services/patients.js');

  beforeEach(async () => {
    ctx = await setupTestApp();
    eligibility = await import('../server/services/eligibility.js');
    patients = await import('../server/services/patients.js');
  });
  afterEach(() => ctx.teardown());
